...
export default function Related_product() {
    ...
    // Set the filter to "advanced" when component mounts
    useEffect(() => {
        setSelectedDifficulty("advanced");
    }, [setSelectedDifficulty]);

    // Filter only Advanced category courses
    const advancedProducts = allProducts.filter(
        (product: Course) => product.category.toLowerCase() === 'advanced'
    );
        ...
        return (
            <div className="min-h-screen bg-white px-6 md:px-16 py-10 text-[#1c2b36]">
                <div className="max-w-6xl mx-auto">
                    <p className="text-sm text-gray-500 mb-2">Home / Advanced</p>
                    <h1 className="text-4xl font-bold mb-8">Advanced</h1>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="flex items-center space-x-2 text-gray-500">
                        ...
                        <span>Showing {advancedProducts.length} results</span>
                    </div>
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-10">
                    {advancedProducts.map((product: Course, index: number) => (
                        <div key={product._id} className="text-center">
                            <div className="bg-white rounded overflow-hidden shadow-md">
                                ...
                                <div className="py-4 px-2">
                                    <p className="text-sm text-gray-500 mb-1">Advanced</p>
                ...
                {advancedProducts.length === 0 && (
                    <div className="mt-12 flex justify-center">
                        <p className="text-lg text-gray-600">No Advanced courses found.</p>
                    </div>
                )}
            </div>
        </div>
